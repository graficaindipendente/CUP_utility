...
return
        ...
        F3::
        {
            ...
            if (!guiCreated) {
                ...
                Gui, Show, x%x% y%y%, ULSS9 Scaligera - noTemp.tab v1.98.11
                guiCreated := true
            }
